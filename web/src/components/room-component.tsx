...
export function RoomComponent() {
  ...
  return (
    <LiveKitRoom
      ...
      audio={true}
      className="flex flex-col md:grid md:grid-cols-[1fr_360px] lg:grid-cols-[1fr_300px] xl:grid-cols-[1fr_360px] flex-grow overflow-hidden border-l border-r border-b rounded-b-md"
      style={{ "--lk-bg": "white" } as React.CSSProperties}
    >
      <AgentProvider>
        {/* Comment out the Configuration section */}
